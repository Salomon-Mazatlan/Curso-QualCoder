  ...
  modulos: [
    ...
    },
    {
      ...
      lecciones: [
        ...
        { id: "17-graficos-y-nubes", titulo: "Gráficos y nubes de palabras",
          archivo: "lecciones/17-graficos-y-nubes.md", minutos: 30,
          resumen: "Distribuciones que describen el corpus y nubes léxicas con criterio." },
        { id: "18-grafos-y-modelos", titulo: "Grafos y modelos analíticos",
          archivo: "lecciones/18-grafos-y-modelos.md", minutos: 40,
          resumen: "El lienzo de grafos, las relaciones nombradas y el modelo que se publica." }
      ]
    },
    {
      id: "m5",
      ...
      color: "var(--marca-5)",
      lecciones: [
        { id: "19-memos-y-diarios", titulo: "Memos, diarios y rastro del proceso",
          archivo: "lecciones/19-memos-y-diarios.md", minutos: 25,
          resumen: "Dónde escribir cada cosa para que el análisis quede auditable." },
        { id: "20-exportar-e-interoperar", titulo: "Exportar, QDPX e interoperabilidad",
          archivo: "lecciones/20-exportar-e-interoperar.md", minutos: 25,
          resumen: "Salidas del proyecto y el intercambio con ATLAS.ti, NVivo y MAXQDA." },
        { id: "21-equipo-y-publicacion", titulo: "Trabajo en equipo y publicación abierta",
          archivo: "lecciones/21-equipo-y-publicacion.md", minutos: 35,
          resumen: "Repartir la codificación, medir el acuerdo, fusionar proyectos y publicar." },
        { id: "22-mantenimiento-y-consultas", titulo: "Mantenimiento y consultas",
          archivo: "lecciones/22-mantenimiento-y-consultas.md", minutos: 30,
          resumen: "Corregir textos ya codificados, reparar vínculos y consultar el proyecto." }
      ]
    },
    {
      id: "m6",
      ...
      color: "var(--marca-2)",
      lecciones: [
        { id: "23-examen-y-constancia", titulo: "Examen de retroalimentación y constancia",
          archivo: "lecciones/23-examen-y-constancia.md", minutos: 30,
