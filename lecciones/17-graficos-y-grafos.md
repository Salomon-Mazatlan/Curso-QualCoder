...
- **Antes de empezar** haber recuperado y leído segmentos (lección 15)
- **Materiales** el proyecto codificado
- **Al terminar tendrás** un modelo gráfico de tu hallazgo principal, exportado
:::
...
Video 17.1. Generación de gráficos de distribución de códigos por caso y por categoría.
:::

## 17.2 Nubes de palabras
...
::: video https://www.youtube.com/watch?v=p2pWR1IrKbg
Video 17.2. Generación de gráficos de distribución y de una nube de palabras filtrada.
:::
<!-- verificar: Boucher y Holian, Emerging forms of representing qualitative data (2001), p. 208 -->
Carlene Boucher y Rosalie Holian reunieron un volumen sobre formas emergentes de representar
datos cualitativos, y describían ya en 2001 un movimiento que hoy es corriente en revistas y
congresos.
...
Los grafos y los gráficos del programa entran en ese movimiento, y con la misma condición que
señalan las autoras. Una representación alternativa tiene que decir algo que el texto no dice
mejor, o solo agrega ruido visual al argumento.



::: video https://www.youtube.com/watch?v=p2pWR1IrKbg
Video 17.3. Nube de palabras con filtrado de palabras vacías.
:::

## 17.3 El lienzo de grafos
...
::: video https://www.youtube.com/watch?v=p2pWR1IrKbg
Video 17.4. Construcción de un modelo en el lienzo, trayendo una rama de códigos y acomodándola.
:::
...
## 17.5 Llevar las figuras a la publicación
...
::: video https://www.youtube.com/watch?v=p2pWR1IrKbg
Video 17.6. Exportación de un grafo como imagen y como diagrama editable.
:::
...
::: consejo Co-ocurrencia y relación no son lo mismo
La co-ocurrencia es un dato sobre cómo codificaste. La relación de un grafo es una
afirmación tuya, y por eso lleva nombre y se puede discutir. Una línea sin nombre solo dice
que dos cosas están conectadas.
:::

::: consejo Un modelo publicable es pequeño
Rara vez pasa de quince nodos. Si el grafo resulta ilegible, quita todo lo que no participe
en la relación que quieres mostrar y haz un segundo grafo con el resto.
:::

::: comprobacion
- Generaste un gráfico que aporta algo que el texto no dice mejor
- Tu grafo tiene las relaciones nombradas, no solo líneas
- El modelo se lee a tamaño de publicación y en blanco y negro
- El grafo quedó guardado dentro del proyecto con un nombre claro
:::
