...
Esta lección es donde más se nota el anclaje doble. Antes de crear un atributo, comprueba que
esa misma información no la estés registrando ya con códigos, y al revés. Una de las dos vías
sobra, y sostener las dos durante meses es la manera más eficaz de terminar con conteos que no
cuadran.
:::
