...
Y antes de importar nada, mira tu tabla de anclaje. Si en ella hay filas ancladas en casos o en
atributos, conviene tener decidida esa estructura antes de que entre el primer archivo, porque
después reasignar material cuesta bastante más.
:::
...
> La guía de campo de Family Health International ordena el manejo de materiales en una secuencia de pasos numerados. Uno de ellos ocupa siempre la misma posición, antes de que el archivo salga de las manos de quien transcribe.
