...
::: video
Exportación del libro de códigos y de un proyecto completo en formato REFI-QDA.
:::
...
::: captura
Menú de exportación con las opciones de libro de códigos y de proyecto REFI-QDA.
:::
...
::: quiz
Vas a colaborar con una colega que usa MAXQDA y solo necesitan compartir el sistema de códigos.
¿Qué conviene enviarle?
