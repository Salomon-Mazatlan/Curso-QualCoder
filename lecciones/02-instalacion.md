...
## 2.6 Primer recorrido por la ventana principal

Antes de crear nada conviene abrir el programa y reconocer el terreno, porque QualCoder reparte
sus funciones de una manera que al inicio despista.

La ventana principal está casi vacía a propósito. Sin un proyecto abierto la mayoría de los
menús aparecen apagados, y eso no es un error de instalación, es que casi todo depende de que
exista un proyecto.

Hay tres caminos para llegar a cada función, y usar los tres es lo que hace ágil el trabajo. La
barra de menús agrupa por familias, la barra de iconos da acceso directo a lo más frecuente, y
los atajos de teclado hacen el resto. Los atajos siguen en general la inicial del nombre en
inglés, aunque tengas la interfaz en español, así que la T lleva a texto y la G al grafo.

| Zona de la ventana | Qué encontrarás ahí |
|---|---|
| Menú de proyecto | Crear, abrir, cerrar, respaldar, importar y exportar |
| Menú de gestión | Archivos, casos, atributos, diarios, referencias y codificadores |
| Menú de codificación | Los módulos de texto, PDF, imagen y audiovisual, y el árbol de códigos |
| Menú de informes | Recuperación, frecuencias, co-ocurrencias, gráficos y comparaciones |
| Menú de IA | Activación, proveedores y funciones asistidas |
| Pestaña de mensajes | El registro de lo que el programa fue diciendo mientras trabajabas |

::: video https://www.youtube.com/watch?v=p2pWR1IrKbg
Video 2.6. Recorrido por la ventana principal, los menús, la barra de iconos y la pestaña de mensajes.
:::

::: captura img/captura-02-04.png
Captura 2.4. Ventana principal recién abierta, con los menús y la barra de iconos señalados.
:::

::: consejo La pestaña de mensajes es el sitio donde aparecen los avisos
Varias operaciones informan de lo que hicieron sin abrir ninguna ventana emergente, y ese aviso
solo queda registrado ahí. Míralo después de abrir el proyecto y después de cualquier operación
grande, sobre todo importaciones y fusiones. Es el hábito que más problemas silenciosos
descubre a tiempo.
:::
