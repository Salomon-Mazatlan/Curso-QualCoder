...
::: quiz
Dos personas del equipo usaron el código `apoyo` con definiciones distintas y ahora hay que
fusionar los proyectos. ¿Qué conviene hacer antes?
- [ ] Fusionar y revisar después los segmentos raros
- [x] Renombrar uno de los dos códigos para que la fusión no los junte, y decidir luego si se unifican
